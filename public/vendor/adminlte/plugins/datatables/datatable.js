...
var Datatable = function() {
    ...
    return {
        ...
        init: function(options) {
            ...
            options = $.extend(true, {
                ...
                dataTable: {
                    ...
                    "language": { // language settings
                        ...
                        "metronicAjaxRequestGeneralError": "Could not complete request. Please check your api data",
            ...
            jQuery('.btn-search-data-table').on("change", function(e){
                e.preventDefault();
                the.submitFilter();
            });

            jQuery(".btn-refresh-data-table").on('click', function(e) {
                e.preventDefault();
                the.resetFilter();
            });
            ...
            jQuery('input.form-filter').on("change", function(e) {
              e.preventDefault();
              the.submitFilter();
            });
